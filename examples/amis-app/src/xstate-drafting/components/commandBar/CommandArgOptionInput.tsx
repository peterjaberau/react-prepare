...
const contextSelector: any = (snapshot: StateFrom<AnyStateMachine> | undefined) =>
  snapshot?.context
...
function CommandArgOptionInput({
  ...
  const { commandBarSend, commandBarState }: any = useCommandsContext()
  ...
  const currentOption = useMemo(
    () =>
      resolvedOptions.find(
        (o: any) => o.value === commandBarState.context.argumentsToSubmit[argName]
      ) || resolvedOptions.find((o: any) => o.isCurrent),
  ...
  const [selectedOption, setSelectedOption] = useState<any>(currentOption || resolvedOptions[0])
