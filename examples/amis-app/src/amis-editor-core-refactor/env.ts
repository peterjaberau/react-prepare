...
export const env: RenderOptions = {
  updateLocation: () => {},
  jumpTo: () => {
    toast.info('Warm reminder: Jumping is prohibited in preview mode');
  },
  ...
  /* Forcibly hiding the error information inside the component will overwrite the internal properties of the component. */
