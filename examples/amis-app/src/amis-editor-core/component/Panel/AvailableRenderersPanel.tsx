...
@observer
export class AvailableRenderersPanel extends React.Component<PanelProps, PanelStates> {
    ...
    return (
      <div className="ae-RendererPanel">
        ...
        <div className="ae-RendererPanel-content">
          ...
          {(!store.showCustomRenderersPanel || Object.keys(groupedCustomRenderers).length < 1) && (
            <RenderersPanel
