...
export default class AMisCodeEditor extends React.Component<AMisCodeEditorProps> {
  ...
  async changeJsonOptions(props: AMisCodeEditorProps = this.props) {
    ...
    let schemaUrl = this.props.$schemaUrl || `${window.location.protocol}//${window.location.host}`
  ...
  editorFactory = (containerElement: HTMLElement, monaco: any, options: any) => {
    const modelUri = monaco.Uri.parse(this.uri)
    this.model = monaco.editor.createModel(this.state.contents, "json", modelUri)
  ...
  editorDidMount = (editor: any, monaco: any) => {
    ...
    this.props.onPaste && this.toDispose.push(this.editor.onDidPaste(this.props.onPaste).dispose)
  }
