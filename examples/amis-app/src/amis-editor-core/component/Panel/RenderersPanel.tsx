...
export default class RenderersPanel extends React.Component<PanelProps, PanelStates> {
  ...
  constructor(props: PanelProps) {
    ...
    this.handleRegionFilterClick = this.handleRegionFilterClick.bind(this)
    this.handleDragStart = this.handleDragStart.bind(this)
    this.handleClick = this.handleClick.bind(this)
    this.changeCollapseFoldStatus = this.changeCollapseFoldStatus.bind(this)
  }
                ...
                <React.Fragment key={tag}>
                  ...
                  >
                    ...
                    <div
                      ...
                      title={!!this.curCollapseFolded[tag] ? "Click to expand" : "Click to collapse"}
                    >
                      ...
                      return (
                        ...
                        >
                          ...
                          >
                            ...
                            {!usePluginIcon && <i className={cx("fa-fw", item.icon || "fa fa-circle-thin")} />}
                          </div>
                          <div className="ae-RendererInfo" data-dnd-id={item.id} onClick={this.handleClick}>
                            {item.name}
                          </div>
                          <TooltipWrapper
                            ...
                            tooltip={{
                              ...
                              children: () => (
                                <div>
                                  ...
                                  <div className="ae-Renderer-preview">{this.renderThumb(item.previewSchema)}</div>
                                </div>
                              ),
                            }}
                          >
