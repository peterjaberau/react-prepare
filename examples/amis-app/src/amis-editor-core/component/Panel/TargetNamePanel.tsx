  ...
  render() {
    ...
    return (
      <div className="ae-TargetName">
        <span>When components such as forms and lists have names, they will appear here for easy selection.</span>
          ...
          {targetNames.map((targetName) => {
            ...
            return (
              <li
                ...
                key={editorId}
              >
                <span className="label label-info pull-right">{targetName.type}</span>
                <a>{targetName.name}</a>
              </li>
            )
          })}
