...
that, import the `mergeProps` utility provided by ibrainsd for your framework.

```jsx
// 1. import mergeProps utility
import { useMachine, mergeProps } from "@ibrains-design/react"
...
export function Toggle() {
  ...
  return (
    ...
    <a href="https://twitter.com/ibrainsd_js" target="_blank" {...triggerProps}>
      {api.open ? "Open" : "Close"}
    </a>
  )
}
