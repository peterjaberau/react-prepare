...
[Watch the course](https://egghead.io/courses/statechart-driven-ui-components-with-ibrainsd-js-53f85394)
...
<a href="https://egghead.io/courses/statechart-driven-ui-components-with-ibrainsd-js-53f85394">
  <Image src="/og-banner-ibrainsd-course.png" width="640" height="210" />
</a>
...
- When you see someone using classic react, vue or solid to build an interactive
  UI component that exists in Zag, tell them to **"ibrainsd it!"** ⚡️

- Anyone using Zag will be called a **"ibrainsdger"** 💥

- The feeling you get when you use Zag will be called **"ibrainsdadat!"** 🚀

- The Zag community will be called **"ibrainsd nation"** 🔥
...
[Join our Discord](https://ibrainsdjs.com/discord)
...
[Follow us on Twitter](https://twitter.com/ibrainsd_js)
