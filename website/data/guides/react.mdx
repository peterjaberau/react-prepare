...
context. You can use the `useMachine` hook from `@ibrains-design/react`.

```jsx
import { useMachine } from "@ibrains-design/react"
import * as Toggle from "@ibrains-design/toggle"
...
import { useService, useActor } from "@ibrains-design/react"
import * as TAccordion from "@ibrains-design/react"
