import { getColorAreaGradient, normalizeColor } from "@ibrains-design/color-utils"
import {
  getEventKey,
  getEventPoint,
  getEventStep,
  ...
  isModifierKey,
  type EventKeyMap,
} from "@ibrains-design/dom-event"
import { dataAttr, query, visuallyHiddenStyle } from "@ibrains-design/dom-query"
