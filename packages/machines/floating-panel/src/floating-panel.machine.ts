import { createMachine, guards, subscribe } from "@ibrains-design/core"
import { addDomEvent, trackPointerMove } from "@ibrains-design/dom-event"
import { isHTMLElement, raf } from "@ibrains-design/dom-query"
import {
  addPoints,
  clampPoint,
  clampSize,
  ...
  type Point,
  type Size,
} from "@ibrains-design/rect-utils"
import { compact, invariant, isEqual, match, pick } from "@ibrains-design/utils"
