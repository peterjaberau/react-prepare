...
function onRouteTelemetrySubmit(data: any, options: {location: Location, navigate: NavigateFunction, filePath: string}) {
  const path: any = options.location.pathname.includes(PATHS.FILE)
    ? options.filePath + PATHS.TELEMETRY + '?tab=project'
    : PATHS.HOME + PATHS.TELEMETRY
 options.navigate(path)
}

function onRouteHomeSubmit(data: any, options: {location: Location, navigate: NavigateFunction, filePath: string}) {
  options.navigate(PATHS.HOME)
}

function onRouteSettingsSubmit(data: any, options: {location: Location, navigate: NavigateFunction, filePath: string}) {
  const path = options.location.pathname.includes(PATHS.FILE)
    ? options.filePath + PATHS.SETTINGS + '?tab=project'
...
export const schema = {
  ...
  routeTelemetryCommandBarSchema: {
    name: 'string',
    displayName: 'string',
    description: 'string',
    groupId: 'string',
...
export const config = {
  ...
  routeTelemetryCommandBarConfig: {
    ...
    icon: 'settings',
    needsReview: false,
    onSubmit: (data: any, options: any) => onRouteTelemetrySubmit(data, options),
  },
  routeHomeCommandBarConfig: {
    name: 'Go to Home',
    ...
    icon: 'settings',
    needsReview: false,
    onSubmit: (data: any, options: any) => onRouteHomeSubmit(data, options),
  },
  routeSettingsCommandBarConfig: {
    name: 'Go to Settings',
    ...
    icon: 'settings',
    needsReview: false,
    onSubmit: (data: any, options: any) => onRouteSettingsSubmit(data, options),
  },
}
